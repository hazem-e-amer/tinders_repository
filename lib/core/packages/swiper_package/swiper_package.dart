...
import 'package:tinders/core/packages/swiper_package/index_controller.dart';
...
import 'package:tinders/core/packages/swiper_package/swiper_pagination.dart';
import 'package:tinders/core/packages/swiper_package/swiper_plugen.dart';
import 'package:tinders/core/packages/swiper_package/transformer_page_view.dart';

part 'swiper_custom_layout.dart';
...
class _StackViewState extends _CustomLayoutStateBase<_StackSwiper> {
  ...
  void _updateValues() {
    if (widget.scrollDirection == Axis.vertical) {
      final space = (_swiperHeight - 80) / 4;
//      - widget.itemHeight
      offsets = [0, -space / 3 * 2, -space / 3, 0.0, 275];
    }
  }
