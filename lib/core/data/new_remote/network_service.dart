...
import 'package:tinders/core/data/new_remote/response_model.dart';
import 'package:tinders/core/data/new_remote/server_config.dart';
...
abstract class NetworkService {
  static Future<T> handleResponse<T>(response,
    ...
    if (response.statusCode == 200) {
      ...
      return errorCallback!(res.message);
    }
  }
  ...
  Uri buildRequestUrl(String endPoint) {
    ...
    if (!endPoint.startsWith('http')) {
      url = Uri.parse('${ServerConfig.baseUrl}$endPoint');
    }
    return url;
  }
